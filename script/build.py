...
def build(source_path, build_path, install_path, targets):
    ...
    """
    src = os.path.join(source_path, "silex_substance_painter")
    ...
    if os.path.exists(build_path):
        with contextlib.suppress(FileNotFoundError):
            shutil.rmtree(os.path.join(build_path, "silex_substance_painter"))
    ...
    shutil.copytree(src, os.path.join(build_path, "silex_substance_painter"))
    ...
    if "install" in (targets or []):
        ...
        shutil.copytree(src, os.path.join(install_path, "silex_substance_painter"))
